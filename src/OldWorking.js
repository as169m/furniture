...
const calculateSofaCosts = ({
  ...
  const upholsteryPricePerSqFt = customSofaUpholsteryCosts[upholsteryType];
...
function App() {
  ...
  const validateInputs = () => {
    const newErrors = {};
    if (laborHourlyRate < 0) newErrors.laborHourlyRate = "Cannot be negative.";
  ...
  const performCalculations = () => {
    ...
    const calculatedLaborCost = laborHours * laborHourlyRate;
          ...
          {activeTab === "rates_materials" && (
            <section className="bg-indigo-50 p-6 rounded-lg shadow-inner">
              ...
              <h3 className="text-xl font-medium text-indigo-700 mb-4 flex items-center">
                <Percent className="w-5 h-5 mr-2" /> Labor & Markup
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="div">
                  <label
                    htmlFor="laborHourlyRate"
                    className="block text-sm font-medium text-gray-700 mb-1"
                  >
              ...
              <section className="bg-gray-50 p-6 rounded-lg shadow-inner mt-6">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    ...
                    {formatCurrency(laborHourlyRate)}/hr (Base USD rate: $
                    {laborHourlyRate.toFixed(2)}/hr)
                  </p>
                  <p>
